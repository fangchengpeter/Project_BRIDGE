...
for monte in range(1):
    with open(f'./result/BRIDGE/result_BRIDGE_b0_{monte}.pickle','rb') as handle:
...
plt.plot(scalar_comms, smooth_bridge_b0*100, markevery=1000, marker='p', color='b')
print(smooth_bridge_b0[4999]*100)
...
plt.legend(['Centralized (faultless)'], loc='lower right', fontsize=14)
plt.subplot(2,2,2)
...
plt.plot(scalar_comms, smooth_bridge_b1*100, markevery=1000, marker='s', color='m')
print(smooth_bridge_b1[4999]*100)
print(smooth_median_b1[4999]*100)
print(smooth_krum_b1[4999]*100)
...
plt.legend(['BRIDGE-T (faultless, b=1)','BRIDGE-M (faultless, b=1)','BRIDGE-K (faultless, b=1)'], loc='lower right', fontsize=13)
...
print(smooth_bridge_b2[4999]*100)
print(smooth_median_b2[4999]*100)
print(smooth_krum_b2[4999]*100)
#plt.plot(scalar_comms, smooth_bulyan_b4*100, markevery=50, marker='x')
...
plt.xlabel('Number of iterations', fontsize=12)
#plt.title('Faulty b=4 setting')
plt.legend(['BRIDGE-T (b=2)','BRIDGE-M (b=2)','BRIDGE-K (b=2)'], loc='lower right', fontsize=14)
...
print(smooth_bridge_b4[4999]*100)
print(smooth_median_b4[4999]*100)
print(smooth_krum_b4[4999]*100)
...
plt.legend(['BRIDGE-T (b=4)','BRIDGE-M (b=4)','BRIDGE-K (b=4)'], loc='lower right', fontsize=14)


plt.savefig('./result/plot_dec2.png', bbox_inches='tight')
