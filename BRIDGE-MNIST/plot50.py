...
for monte in range(3):
    ...
    with open(f'./result/BRIDGE/result_BRIDGE_b6_50_{monte}.pickle','rb') as handle:
        bridge_b6.append(pickle.load(handle))
    
    
    
    with open(f'./result/Median/result_Median_b6_50_{monte}.pickle','rb') as handle:
        median_b6.append(pickle.load(handle))
    with open(f'./result/Median/result_Median_b12_50_{monte}.pickle','rb') as handle:
        median_b12.append(pickle.load(handle))
    with open(f'./result/Median/result_Median_b18_50_{monte}.pickle','rb') as handle:
        median_b18.append(pickle.load(handle))
    with open(f'./result/Median/result_Median_b24_50_{monte}.pickle','rb') as handle:
        median_b24.append(pickle.load(handle))

    with open(f'./result/Krum/result_Krum_b6_50_{monte}.pickle','rb') as handle:
        krum_b6.append(pickle.load(handle))
    with open(f'./result/Krum/result_Krum_b12_50_{monte}.pickle','rb') as handle:
        krum_b12.append(pickle.load(handle))
    with open(f'./result/Krum/result_Krum_b18_50_{monte}.pickle','rb') as handle:
        krum_b18.append(pickle.load(handle))
    with open(f'./result/Krum/result_Krum_b24_50_{monte}.pickle','rb') as handle:
...
plt.legend(['BRIDGE-T (b=6, p=0.5)','BRIDGE-M (b=6, p=0.5)','BRIDGE-K (b=6, p=0.5)'], loc='right', fontsize=14)
...
plt.legend(['BRIDGE-T (b=12, p=0.5)','BRIDGE-M (b=12, p=0.5)','BRIDGE-K (b=12, p=0.5)'], loc='right', fontsize=14)
...
plt.xlabel('Number of iterations', fontsize=12)
#plt.title('Faulty b=2 setting')
plt.legend(['BRIDGE-M (b=18, p=0.5)','BRIDGE-K (b=18, p=0.5)'], loc='right', fontsize=14)
...
plt.legend(['BRIDGE-M (b=24, p=0.5)','BRIDGE-K (b=24, p=0.5)'], loc='right', fontsize=14)
plt.savefig('./result/plot_dec50.png', bbox_inches='tight')